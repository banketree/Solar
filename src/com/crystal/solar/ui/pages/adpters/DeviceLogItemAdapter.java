...
public class DeviceLogItemAdapter extends BaseAdapter
{

	private ArrayList<DeviceLogItem> list;
	private Context context;
	private LayoutInflater inflater;

	public DeviceLogItemAdapter(ArrayList<DeviceLogItem> list, Context context)
	{
		super();
		this.list = list;
	...
	public View getView(int pos, View convertview, ViewGroup arg2)
	{
		...
		DeviceLogItem item = list.get(pos);
